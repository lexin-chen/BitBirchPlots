...
fig, ax = plt.subplots()  # 2x2 grid of subplots, resulting in a 2D array
...
color_labels = []
medoid_smiles = []
for j, cluster in enumerate(big_clusters):
...
plt.savefig('network.png', dpi=500, bbox_inches='tight', pad_inches=0.1, transparent=True)